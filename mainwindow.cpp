...
#define __VERSION "1.1.0.160511 测试版"
#if defined(Q_OS_WIN)
...
QPixmap MainWindow::createIcon(const QString&path)
{
    ...
    QImage image=QPixmap(":/icon/rcfile/folder.png").toImage();
...
void MainWindow::on_actionAbout_triggered()
{
    ...
    msgBox->setText(QString(
        ...
        "<p>版本：%1</p>"
        "<p>构建时间：%2 - %3</p>"
        "<p>Copyright © 2015 绍兴一中 贾越凯。保留所有权利。<br/></p>"
        "<p>项目主页：<a href=\"http://ccr-plus.sourceforge.net\">http://ccr-plus.sourceforge.net</a></p>"
    ...
    msgBox->setIconPixmap(QPixmap(":icon/rcfile/logo.png"));
    msgBox->exec();
}
